                    ...
                    addedfile: function (file) {
                        ...
                        if (this.previewsContainer) {
                            ...
                            if (this.options.addRemoveLinks) {
                                file._removeLink = Dropzone.createElement("<a class=\"dz-remove\" onclick=\"getRequest('/deleteFile', 'fileName', '" + file.name + "');\" data-dz-remove>" + this.options.dictRemoveFile + "</a>");
